...
string filePath = @"C:\Users\dlaxmidhar\Downloads\onlinedb.pfx";
var certificate = new X509Certificate2(filePath, "93EE9D996433A0E1B61FF03749B2AFC7");
...
builder.Services.AddSingleton<IDocumentStore>(provider =>
    new DocumentStore
    {
        ...
        Certificate = new X509Certificate2("onlinedb.pfx", "93EE9D996433A0E1B61FF03749B2AFC7")
    }.Initialize());
