...
namespace RavenDbFinalTest.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public async Task<IActionResult> Index(String email)
        {
            ...
            var client2 = new GraphQLHttpClient(new GraphQLHttpClientOptions { EndPoint = new Uri("https://nodejs-cloud-r5sy.onrender.com") }, new NewtonsoftJsonSerializer());
        ...
        public async Task<IActionResult> LoginAuth(string email2, int userotp)
        {
            ...
            var client = new GraphQLHttpClient(new GraphQLHttpClientOptions { EndPoint = new Uri("https://nodejs-cloud-r5sy.onrender.com") }, new NewtonsoftJsonSerializer());
